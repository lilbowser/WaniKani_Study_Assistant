...
"""
The MIT License (MIT)
Copyright (c) 2015 Aaron Jones

Modified by A Goldfarb 2017

A very thin Python wrapper over the WaniKani API.
This copy has had minor modifications made to it.
...
Usage
-----
1. Import the WaniKani class. `from wanikani_lib import WaniKani`
